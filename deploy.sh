...
java -jar -Dspring.profiles.active=prod -Dspring.config.location=classpath:/application.yml,classpath:/application-prod.yml,classpath:/application-security.yml $DEPLOY_JAR >> /home/ubuntu/app/deploy.log 2>/home/ubuntu/app/deploy_err.log &
