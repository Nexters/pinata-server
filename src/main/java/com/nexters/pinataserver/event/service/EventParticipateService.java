...
public class EventParticipateService {
    ...
    private void writeEventHistory(User participant, Event foundEvent, EventItem hitEventItem, boolean isHit) {
    ...
    private ParticipateEventResponse makeParticipateEventResponse(
        ...
        String hitItemTitle = (hitEventItem != null) ? imageUtil.getFullImageUrl(hitEventItem.getImageFileName()) : null;
        String hitItemImageUrl = (hitEventItem != null) ? imageUtil.getFullImageUrl(hitEventItem.getImageFileName()) : null;
